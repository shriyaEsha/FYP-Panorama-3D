...
def pano(image1,image2,errVal):
  ...
  #blend 
  # alpha = 1                 # Ask the value of alpha
  ...
  #     else:
  #         (y1,x1) = image1.shape[:2]
  #         (y2,x2) = image2.shape[:2]
  #         (x3,y3) = panorama.shape[:2]
  #         print 'offset: ',offset
  #         v = math.ceil(x1/200)
  #         rect1 = image1[0:y1,x1-200:x1]         
  #         rect2 = panorama[0:image1.shape[0],x1:x1+200]
  #         print rect1.shape,rect2.shape
  #         cv2.imwrite("yosemite/rect1.jpg",rect1)
  #         cv2.imwrite("yosemite/rect2.jpg",rect2)
  #         dst = cv2.addWeighted(rect1,alpha,rect2,beta,gamma)  # Get weighted sum of img1 and img2
  #               #dst = np.uint8(alpha*(img1)+beta*(img2))    # This is simple numpy version of above line. But cv2 function is around 2x faster
  #               #cv2.imshow('dst',dst)
  #         cv2.imwrite("yosemite/blended.jpg",dst)
  #         panorama[offset[1]:panorama.shape[0]-8,x1-200:x1] = dst
  #         cv2.imwrite("yosemite/pano_blend.jpg",panorama)
  #         cv2.waitKey(0)
...
if __name__ == "__main__":
  ...
  im3 = cv2.imread(images[2])
  im4 = cv2.imread(images[3])
  errVal = 1
  p = 2
  panorama1 = pano(im1,im2,errVal)
  panorama2 = pano(im3,im4,errVal)
  cv2.imwrite("yosemite/pano11.jpg",panorama1)
  cv2.imwrite("yosemite/pano22.jpg",panorama2)
  im1 = cv2.imread("yosemite/pano11.jpg")
  im1 = cv2.imread("yosemite/pano22.jpg")
  panorama3 = pano(im1,im2,errVal)
  cv2.imwrite("yosemite/pano33.jpg",panorama3)
